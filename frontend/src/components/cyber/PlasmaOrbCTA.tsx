            ...
            <AnimatePresence>
                {!isExploded ? (
                    <div className="relative w-32 h-32 flex items-center justify-center">
                        ...
                        >
                            {/* The Orb */}
                            <div className="absolute inset-0 rounded-full bg-gradient-to-br from-blue-500 via-purple-600 to-crimson shadow-[0_0_50px_rgba(255,0,60,0.5)] border border-white/20">
                                <motion.div
                                    animate={{
                                        boxShadow: isHovered
                            ...
                            {isHovered && [0, 1, 2, 3].map((i) => (
                                <div key={i} className="absolute w-full h-1 bg-blue-400 blur-[1px]">
                                    <motion.div
                    ...
                    <div className="relative w-32 h-32 flex items-center justify-center">
                        {[...Array(12)].map((_, i) => (
                            <div key={i} className="absolute w-4 h-4 bg-white rounded-sm">
                                <motion.div
